...
public class AddBookPanel extends JPanel {
		...
		private void initWidgets() {
			...
			jlFile = new JLabel ("Enter New File:    ");
			...
			jlTitle.setHorizontalAlignment(JTextField.RIGHT);
			jlAuthor.setHorizontalAlignment(JTextField.RIGHT);
		...
		public JTextArea getTextFieldAreaLog(){
			return jtaLog;
		}
